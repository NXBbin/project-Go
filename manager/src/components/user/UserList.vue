      ...
      <el-form :model="itemSetForm" ref="itemSetForm" :rules="itemSetRules" label-width="140px">
        <el-tabs v-model="setDialogActiveName">
          <el-tab-pane label="基本信息" name="general">
						...
						<el-form-item label="密码摘要salt" prop="PasswordSalt">
							<el-input v-model="itemSetForm.PasswordSalt"></el-input>
						</el-form-item>
          </el-tab-pane>
        </el-tabs>
      </el-form>
            ...
            <el-col :span="24">
              ...
              >
                <el-table-column type="index" width="50"></el-table-column>
								...
								<el-table-column prop="Tel" label="电话" sortable="custom"></el-table-column>
